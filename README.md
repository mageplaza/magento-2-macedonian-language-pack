## Magento 2 Macedonian Language Pack
...
```
unzip master.zip app/i18n/Mageplaza/mk_mk
```
...
Unzip the compressed file and upload file `mk_MK.zip` into `app/i18n/mageplaza/mk_MK/mk_MK.csv`
